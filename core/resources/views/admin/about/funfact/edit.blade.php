            ...
            <div class="col-md-12">
              <div class="card card-primary card-outline">
                  ...
                  <div class="card-header">
                      <div class="card-title">{{ __('Edit Fun Facts') }}</div>
                  ...
                  <div class="card-body">
                      <form class="form-horizontal" action="{{ route('admin.updateFunfact',$funfact->id) }}" method="post" enctype="multipart/form-data">
                          @csrf
                          <div class="form-group row">
                            <label for="icon" class="col-sm-2 control-label">{{ __('Icon') }} <span class="text-danger">*</span> </label>
                            <div class="col-sm-10">
                                <img src="{{ asset('assets/front/img/'.$funfact->icon) }}" alt="" class="mw-400 mb-3 show-img img-demo">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="name" id="name" class="form-control" value="{{ $funfact->name }}" placeholder="{{ __('Enter Fact Name') }}">
                                @if($errors->has('name'))
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="value" id="value" value="{{ $funfact->value }}" class="form-control" placeholder="{{ __('Enter Fact Value') }}">
                                @if($errors->has('value'))
