            ...
            <div class="col-md-12">
              <div class="card card-primary card-outline">
                  ...
                  <div class="card-header">
                      <div class="card-title">{{ __('Update Blog') }}</div>
                  ...
                  <div class="card-body">
                      <form class="form-horizontal" action="{{ route('admin.updateBlog',$blog->id) }}" method="post" enctype="multipart/form-data">
                          @csrf
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <img src="{{ asset('assets/front/img/'.$blog->main_image) }}" alt="" class="mw-400 mb-3 show-img img-demo">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="title" id="title" class="form-control" value="{{ $blog->title }}" placeholder="{{ __('Blog Title') }}">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select name="bcategory_id" id="bcategory_id" class="form-control">
                                    ...
                                    <option value="{{ $bcategory->id }}" {{ $blog->bcategory_id == $bcategory->id ?'selected':'' }} >{{ $bcategory->name }}</option>
                                    @endforeach
                                </select>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="content"  class="form-control summernote" rows="5" >{{ $blog->content }}</textarea>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="share_code"  class="form-control summernote" rows="3" placeholder="{{ __('Enter Your Embade Code') }}" >{{ $blog->share_code }}</textarea>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="meta_keywords" data-role="tagsinput" id="meta_keywords" class="form-control"  value="{{ $blog->meta_keywords }}" placeholder="{{ __('Meta Keywords') }}">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="meta_description"  class="form-control summernote" rows="3"  placeholder="{{ __('Meta Description') }}">{{ $blog->meta_description }}</textarea>
