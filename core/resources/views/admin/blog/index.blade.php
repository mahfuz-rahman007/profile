            ...
            <div class="col-md-12">
              <div class="card card-primary card-outline">
                  ...
                  <div class="card-header">
                      <div class="card-title">{{ __('Blogs List') }}</div>
                    ...
                    <table id="idtable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ ++$id }}</td>
                                <td>
                                    <img src="{{ asset('assets/front/img/'.$blog->main_image) }}" alt="" class="w-100">
                                </td>
                                <td>{{ $blog->title }}</td>
                                ...
                                <td width="18%">
                                    <a href="{{ route('admin.editBlog',$blog->id) }}" class="btn btn-info btn-sm"> <i class="fas fa-edit"></i>{{ __('Edit') }} </a>
                                    <form id="deleteform" class="deleteform d-inline-block" action="{{ route('admin.deleteBlog', $blog->id) }}"
                                        method="post">
                                        @csrf
