            ...
            <div class="col-md-12">
              <div class="card card-primary card-outline">
                  ...
                  <div class="card-header">
                      <div class="card-title">{{ __('Add Eduction') }}</div>
                  ...
                  <div class="card-body">
                      <form class="form-horizontal" action="{{ route('admin.storeEducation') }}" method="post" enctype="multipart/form-data">
                          @csrf

                          <div class="form-group row">
                            <label for="institution" class="col-sm-2 control-label">{{ __('Institution Name') }} <span class="text-danger">*</span> </label>
                            <div class="col-sm-10">
                                <input type="text" name="institution" id="institution" class="form-control" placeholder="{{ __('Enter Institution Name') }}">
