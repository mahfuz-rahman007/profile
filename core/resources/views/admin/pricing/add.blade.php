            ...
            <div class="col-md-12">
              <div class="card card-primary card-outline">
                  ...
                  <div class="card-header">
                      <div class="card-title">{{ __('Add New Pricing Plan') }}</div>
                  ...
                  <div class="card-body">
                      <form class="form-horizontal" action="{{ route('admin.storePricing') }}" method="post" enctype="multipart/form-data">
                          @csrf

                          <div class="form-group row">
                            <label for="currency" class="col-sm-2 control-label">{{ __('Currency') }} <span class="text-danger">*</span> </label>
                            <div class="col-sm-10">
                                <input type="text" name="currency" id="currency" class="form-control" placeholder="{{ __('Enter Currency') }}">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="price" id="price" class="form-control" placeholder="{{ __('Enter Price') }}">
                                @if($errors->has('price'))
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="content" id="content" rows="5" class="form-control summernote" placeholder="{{ __('Plan Description') }}"></textarea>
