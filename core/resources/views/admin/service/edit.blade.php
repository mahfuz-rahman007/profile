        ...
        <div class="row">
            <div class="col-md-12">
              <div class="card card-primary card-outline">
                  ...
                  <div class="card-body">
                      <form class="form-horizontal" action="{{ route('admin.updateService',$service->id) }}" method="post" enctype="multipart/form-data">
                          @csrf

                          <div class="form-group row">
                            <label for="image" class="col-sm-2 control-label">{{ __('Icon') }} <span class="text-danger">*</span> </label>
                            <div class="col-sm-10">
                                <img src="{{ asset('assets/front/img/'.$service->image) }}" alt="" class="w-100 mb-3 show-img img-demo">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <img src="{{ asset('assets/front/img/'.$service->featured_image) }}" alt="" class="mw-400 mb-3 show-img img-demo">
                                <div class="custom-file">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="name" id="name" class="form-control" value="{{ $service->name }}" placeholder="{{ __('Enter Name') }}">
                                @if($errors->has('name'))
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="description"  class="form-control summernote" rows="3" placeholder="{{ __('Short Description') }}">{{ $service->description }}</textarea>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="content"  class="form-control summernote" rows="4" >{{ $service->content }}</textarea>
