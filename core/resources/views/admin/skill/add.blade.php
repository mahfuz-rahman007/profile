        ...
        <div class="row">
            <div class="col-md-12">
              <div class="card card-primary card-outline">
                  ...
                  <div class="card-body">
                      <form class="form-horizontal" action="{{ route('admin.storeSkill') }}" method="post" enctype="multipart/form-data">
                          @csrf
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="level" id="level" class="form-control" placeholder="{{ __('Level') }}">
                                @if($errors->has('level'))
